...
\chapter{Professional, Legal, Ethical, and Social Issues} % Main appendix title

\label{AppendixB} % For referencing this appendix elsewhere, use \ref{AppendixA}

\lhead{Appendix B. \emph{Appendix B}} % This is for the header on each page - perhaps a shortened title
