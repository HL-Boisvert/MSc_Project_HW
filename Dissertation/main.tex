...
\includepdf[pages={-}, scale=1, offset=68 -55]{./Figures/Authorship.pdf}
...
I would like to thank my project supervisor Dr Ekaterina Komendantskaya for the time she spent providing me with guidance and advice. I would also like to thank the other members of the Lab for Artificial Intelligence Verification (LAIV), especially Luca Arnaboldi and Marco Casadio for sharing their technical knowledge on Reinforcement Learning and the F1Tenth system.
}
\clearpage % Start a new page
