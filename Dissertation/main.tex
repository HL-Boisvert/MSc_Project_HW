...
\emph{Author:}\\
\href{hb2017@hw.ac.uk}{\authornames} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}{0.4\textwidth}
\begin{flushright} \large
\emph{Supervisor:} \\
\href{https://www.macs.hw.ac.uk/~ek19/}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
...
%\end{itemize}
 \vspace{2cm} 
Signed: \textit{Henri-Louis Boisvert}\\
...
\newline
This project will have a double aim. Firstly, it will be to compare the performance of different autonomous racing controllers and their ability to generalise to new data to help users choose one that correspond to their needs. Secondly, it will be to compare the Sim2Real gap to give users an idea of performance in real life situations; this will be achieved by using the F1Tenth platform. This research report details my review of the relevant literature, establishes research questions, hypotheses, objectives and provides a clear project plan. 
\clearpage % Start a new page
...
I would like to thank my project supervisor Dr. Ekaterina Komendantskaya for the time she spent providing me with guidance and advice. I would also like to thank the other members of the Lab for Artificial Intelligence Verification (LAIV), especially Luca Arnaboldi for sharing his technical knowledge on Reinforcement Learning and the F1Tenth system.
}
\clearpage % Start a new page
