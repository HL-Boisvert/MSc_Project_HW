...
class State:
    ...
    def setup(args):
        ...
        State.cut_by = 10 # Remove the 10 minimum and 10 maximum outliers 
        State.max_distance_norm = 20 # Divide by 20 to normalize distances (considering 20 is the max distance that can be returned)
