...
VELOCITY_NORMALIZATION = 0.3 # Normalize the speed between 0 and 1 (=1/max_speed)
...
class CarEnv:
    ...
    def __init__(self, args):
        ...
        self.add_velocity = args.add_velocity # Whether to use velocity for the state
    ...
    def _get_car_state(self):
        ...
        if self.add_velocity: # If we use the velocity in the state
